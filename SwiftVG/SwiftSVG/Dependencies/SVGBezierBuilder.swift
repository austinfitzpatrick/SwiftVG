...
//import Foundation
//
//class SVGBezierBuilder: NSObject {
//    
//    class func bezierPathFromSVGString(d:String){
//        
//    }
//    
//    enum CommandType {
...
//
//protocol SVGCommand {
//    func processCommandString(commandString:String, withPrevoiusCommand prevCommand:NSString, forPath path:UIBezierPath)
//}
//
//class SVGCommandImplementation: SVGCommand {
//
//    struct Static {
//        static let ParamRegex:NSRegularExpression = NSRegularExpression(pattern: "[-+]?[0-9]*\\.?[0-9]+", options: .allZeros, error: nil)!
//    }
//    
//    var previousCommand:String?
//    
//    func getCommandParameters(commandString:String) -> CGFloat {
//        let regex = Static.ParamRegex
//        let matches = regex.matchesInString(commandString, options: .allZeros, range: NSMakeRange(0, commandString.utf16Count))
//
//    }
//    
//    func processCommandString(commandString: String, withPrevoiusCommand prevCommand: NSString, forPath path: UIBezierPath) {
